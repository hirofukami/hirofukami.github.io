  ...
  <ul>
    <li>
      iBGP ではフルメッシュ peering が必要だが、複数台存在する時点でルートリフレクタ(RR)を用いる</p> <ul>
        ...
        <li>
          複数 RR を置いている場合は同じ Cluster ID を付ける<span class="footnote"><a href="/d_sea/#f1" name="fn1" title='NANOG31 "BGP Techniques for Internet Service Providers" by Philip Smith' target="_blank">*1</a></span> <ul>
            <li>
    ...
    <li>
      nexthop-self の活用 <ul>
        ...
        <li>
          eBGP では1ルータで複数 peering している時に peer 先に対して誤った nexthop を広報しないようにする意味で有効<span class="footnote"><a href="/d_sea/#f2" name="fn2" title='Internetweek2005 "ISPバックボーンネットワークにおける経路制御設計 ～実践編～" by 吉田友哉, NTT-Com' target="_blank">*2</a></span>
        </li>
      </ul>
    </li>
      ...
      Area0 にいくつまでルータが置けるか</p> <ul>
        <li>
          ルータのスペックにもよるが、厳密な推奨台数は無いためやってみてが多い</p> <ul>
            <li>
              1996年の文献では40～50台のルータが経験上、上限だといっている<span class="footnote"><a href="/d_sea/#f3" name="fn3" title='"OSPF設計ガイド" by Sam Halabi, Cisco Systems, Inc. 1994.04.01' target="_blank">*3</a></span>
            </li>
          </ul>
        </li>
...
<div class="footnote">
  <p class="footnote">
    <a href="/d_sea/#fn1" name="f1" target="_blank">*1</a>：NANOG31 &#8220;BGP Techniques for Internet Service Providers&#8221; by Philip Smith
  </p>
  
  <p class="footnote">
    <a href="/d_sea/#fn2" name="f2" target="_blank">*2</a>：Internetweek2005 &#8220;ISPバックボーンネットワークにおける経路制御設計 ～実践編～&#8221; by 吉田友哉, NTT-Com
  </p>
  
  <p class="footnote">
    <a href="/d_sea/#fn3" name="f3" target="_blank">*3</a>：&#8221;OSPF設計ガイド&#8221; by Sam Halabi, Cisco Systems, Inc. 1994.04.01
  </p>
</div>