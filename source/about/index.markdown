...
過去にシリコンバレーでスタートアップやって失敗して再チャレンジ中
...
*   RSS : [http://hirofukami.com/atom.xml](http://hirofukami.com/atom.xml)
...
*   やれること・やってること 
    ...
    *   できることのレイヤを上げてきてネットワーク/サーバのインフラづくりと運用からiPhoneアプリを作ったりまで
...
*   Extreme Meeting
*   Cost Cut
*   Cloud Computing/Virtual Machine/Cloud Management/CloudStack
...
Facebook/TwitterなどのソーシャルネットワークからでもOKです。
 ...
 [7]: http://www.amazon.co.jp/gp/product/4774142840/ref=as_li_ss_tl?ie=UTF8&camp=247&creative=7399&creativeASIN=4774142840&linkCode=as2&tag=dsea-22
